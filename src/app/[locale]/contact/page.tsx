...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const description = isDE
    ? 'Kontaktieren Sie uns für Buchungen und Anfragen. Villa Ballena & Villa Beluga in Svetvinčenat, Istrien. Telefon, E-Mail oder WhatsApp.'
  ...
  return {
    ...
    alternates: { canonical: `${baseUrl}/${locale}/contact`, languages: { en: `${baseUrl}/en/contact`, de: `${baseUrl}/de/contact`, 'x-default': `${baseUrl}/en/contact` } },
  };
}
