    ...
    <section className="bg-bg">
      ...
      <div className="py-32 lg:py-48">
        <div className="mx-auto max-w-[900px] px-6 lg:px-10 text-center">
          <h2 className="display-lg">Elevate Your Next Offsite</h2>
          <p className="mt-6 micro-italic">Where strategy and inspiration converge</p>
          <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link href="/contact" className="btn-editorial">Get Corporate Quote</Link>
