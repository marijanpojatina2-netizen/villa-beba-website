    ...
    <section ref={sectionRef} className="section-editorial bg-bg">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        ...
        <div className="mb-10 flex flex-wrap gap-2">
          {tabs.map((tab, i) => (
            <button key={tab.key} onClick={() => setActiveTab(i)} className={`btn-editorial !text-[0.625rem] !px-5 !py-2 ${activeTab === i ? '!bg-text !text-bg !border-text' : ''}`}>{tab.label}</button>
          ))}
        </div>
  ...
  return (
    <section ref={sectionRef} className="section-editorial bg-bg-elevated">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4">
          <div className="lg:col-span-5"><h2 className="display-lg">{t('dayTitle', { villa: 'Villa Ballena' })}</h2></div>
